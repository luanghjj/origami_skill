    ...
    const DRINKS = [
      ...
      { cat: "Đồ uống không cồn", name: "Coca-Cola", desc: "Nước ngọt có ga", ingredients: ["Coca-Cola"], glass: "Ly cao", note: "Thêm đá, lát chanh tùy chọn" },
      ...
      { cat: "Đồ uống nóng", name: "Espresso", desc: "Cà phê Espresso 1 shot", ingredients: ["Espresso (1 shot)"], glass: "Demitasse (tách nhỏ)", note: "30ml, phục vụ kèm đường" },
      { cat: "Đồ uống nóng", name: "Doppio", desc: "Espresso đôi (2 shot)", ingredients: ["Espresso đôi (2 shot)"], glass: "Tách Espresso lớn", note: "60ml" },
      { cat: "Đồ uống nóng", name: "Cappuccino", desc: "Espresso với sữa bọt", ingredients: ["Espresso (1 shot)", "Sữa nóng (Milch)", "Bọt sữa (Milchschaum)"], glass: "Tách Cappuccino 180ml", note: "1/3 Espresso – 1/3 sữa nóng – 1/3 bọt sữa, rắc bột cacao" },
      { cat: "Đồ uống nóng", name: "Grün Tee", desc: "Trà xanh", ingredients: ["Trà xanh (Grüntee)"], glass: "Ấm trà + tách", note: "Ủ 70–80°C, không dùng nước sôi" },
      ...
      /* ─── Cocktail không cồn ─── */
      { cat: "Cocktail không cồn", name: "Asian Cooler", desc: "Cocktail bạc hà - gừng mát lạnh", ingredients: ["Bạc hà tươi (Minze)", "Chanh tươi (Zitrone)", "Đường mía (Rohrzucker)", "Ginger Ale"], glass: "Ly cao (Highball)", note: "Giã nhuyễn bạc hà + chanh + đường mía (Muddling), thêm đá bào, top với Ginger Ale, trang trí lá bạc hà" },
      ...
      /* ─── Bia ─── */
      { cat: "Bia", name: "Kirin Ichiban", desc: "Bia Nhật Bản cao cấp", ingredients: ["Kirin Ichiban (chai/lon)"], glass: "Ly bia / Ly Pilsner", note: "Bia Nhật vị nhẹ, bọt vừa — rót nghiêng ly 45°" },
      ...
      { cat: "Khai vị & Cocktail", name: "Hugo", desc: "Khai vị hoa cơm cháy mùa hè", ingredients: ["Prosecco", "Bạc hà tươi (Minze)", "Chanh tươi (Zitrone)", "Siro hoa cơm cháy (Holunderblütensirup)"], glass: "Ly Wine / Ly Champagne", note: "Thêm đá, mint + chanh + siro, top với Prosecco — trang trí cành bạc hà" },
      { cat: "Khai vị & Cocktail", name: "Aperol Spritz", desc: "Khai vị Aperol cổ điển", ingredients: ["Aperol", "Prosecco", "Soda / Nước có ga"], glass: "Ly Wine lớn (250ml)", note: "Tỉ lệ Aperol : Prosecco : Soda = 3 : 2 : 1 — thêm đá, trang trí lát cam" },
      ...
      { cat: "Khai vị & Cocktail", name: "Moscow Mule", desc: "Cocktail Vodka gừng", ingredients: ["Vodka", "Ginger Beer", "Nước cốt chanh (Zitronensaft)"], glass: "Ly đồng (Copper Mug)", note: "Vodka + nước cốt chanh + đá, top với Ginger Beer, trang trí lát chanh + lá bạc hà" },
      { cat: "Khai vị & Cocktail", name: "Gin Tonic (Roku)", desc: "Gin Tonic với Roku Gin", ingredients: ["Roku Gin", "Tonic Water"], glass: "Ly Balloon / Ly Highball", note: "Tỉ lệ 1:3 — thêm đá, trang trí theo phong cách Roku (vỏ cam, lá húng quế...)" },
      ...
      /* ─── Sake & Rượu vang ─── */
      { cat: "Sake & Rượu vang", name: "Sake SOTO", desc: "Rượu gạo Nhật Bản cao cấp", ingredients: ["Sake SOTO"], glass: "Chén sake (Ochoko) hoặc ly nhỏ", note: "Có thể phục vụ lạnh (Reishu), nhiệt độ phòng (Jōon) hoặc nóng (Atsukan)" },
      ...
      { cat: "Sake & Rượu vang", name: "Rosé", desc: "Rượu vang hồng", ingredients: ["Rượu vang hồng (Rosé)"], glass: "Ly vang hồng", note: "Phục vụ lạnh 10–12°C" },
    ...
    function loadDrinkImages() {
      try { return JSON.parse(localStorage.getItem(DRINK_IMAGES_KEY) || '{}'); } catch(e) { return {}; }
    }
